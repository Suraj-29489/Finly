...
/**
 * Clean Compose screen for recording new income transactions.
 * Features an emerald green inflow color scheme to clearly distinguish income from expenses.
 */
@Composable
fun AddIncomeScreen(
        ...
        Card(
            ...
            Column(
                ...
                if (uiState.successMessage != null) {
                    Card(
                        colors = CardDefaults.cardColors(
                            containerColor = StatusSuccessContainer.copy(alpha = 0.45f)
                        ),
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                if (uiState.lastInsertedIncome != null) {
                                    TextButton(
                                        onClick = { onEditIncome(uiState.lastInsertedIncome!!) },
                                        contentPadding = androidx.compose.foundation.layout.PaddingValues(0.dp)
                                    ) {
                                        Text(
                                            text = "Edit recorded income",
                                            color = StatusSuccess,
                ...
                // Amount Field (Inflow emerald styling)
                OutlinedTextField(
                ...
                // Submit Button
                Button(
                    onClick = { viewModel.onAddIncomeClick() },
                    ...
                    Text(
                        text = if (uiState.isSubmitting) "Recording Income..." else "Record Income",
                        style = MaterialTheme.typography.titleMedium,
                        fontWeight = FontWeight.Bold
                    )
                }
